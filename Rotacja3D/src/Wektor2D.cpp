    ...
    while(1)
        {
            ...
            if(std::cin.fail())
            {
                std::cin.clear();
                std::cin.ignore(1000,'\n');
                std::cerr << "Błąd niepoprawna wspolrzedna x. Sprobuj ponownie." << std::endl;
            }
            else break;
        }
        ...
        while(1)
        {
            ...
            if(std::cin.fail())
            {
                std::cin.clear();
                std::cin.ignore(1000,'\n');
                std::cerr << "Błąd niepoprawna wspolrzedna y. Sprobuj ponownie." << std::endl;
            }
            else break;
        }
	while(1)
	  {
		...
		std::cin.clear();
		std::cin.ignore(1000,'\n');
		std::cerr << "Błąd niepoprawna wspolrzedna z. Sprobuj ponownie." << std::endl;
	      }
	    else break;
	  }
    return Strm;
